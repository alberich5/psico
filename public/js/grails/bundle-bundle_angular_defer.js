...
function DefaultErrorMessageResolverFn($q, $http) {
  var currentCulture = 'en-gb',
    ...
    i18nFileRootPath = '../static/js/angular-auto-validate/dist/lang',
    i18nFileRootPath2 = 'static/js/angular-auto-validate/dist/lang',
    ...
    loadRemoteCulture = function (culture) {
      ...
      cultureRetrievalPromise.then(function(e){return e},function(error){
    	  return $http.get('{0}/jcs-auto-validate_{1}.json'.format(i18nFileRootPath2, culture.toLowerCase()))  
      })
  ...
  showErrorsModule.directive('showErrors', [
    '$timeout', 'showErrorsConfig', '$interpolate', function($timeout, showErrorsConfig, $interpolate) {
      ...
      linkFn = function(scope, el, attrs, formCtrl) {
        ...
        scope.$on('show-errors-check-validity', function (event,currentForm) {
        	...
        	if(currentForm!==undefined){
        		if (currentForm[inputName] != null){
        			return toggleClasses(currentForm[inputName].$invalid,currentForm.$name);
        		}
        	
        	}
        	else{
        		console.log("aqui error",formCtrl)
                    return toggleClasses(formCtrl[inputName].$invalid);
        ...
        return toggleClasses = function(invalid,currentForm) {
        	
        	if(currentForm!==undefined){
        		var form=el.parent('form').get(0)
